<template>
  <div class="page-shell">
    <section class="dashboard-hero">
      <div class="dashboard-hero__main">
        ...
        <div class="hero-actions">
          <el-button type="primary" @click="router.push('/services')">发起新预约</el-button>
          <el-button plain @click="quickVisible = true">快捷操作</el-button>
        </div>
      </div>
    ...
    <div v-if="filteredBookings.length === 0" class="empty-state">
      ...
      <p class="empty-state__title">暂无预约记录</p>
      <p class="empty-state__desc">前往服务中心发起会议室、设备或咨询预约</p>
